...
#define LOOPTIME              5000.0 - 120.0            // Desired speed of the main loop in microseconds used to 2700
#define DT                    1.0/(4880.0/1000000.0)  //dt in seconds
#define DT_INV                1.0/DT                    //inv dt in 1/seconds
#define LOOPHZ                1.0/(4880.0/1000000.0)  // Desired Hz of the main loop
#define DEBUGTIME             100000                    // Desired speed of the main loop in microseconds
#define COMMAND_TIMEOUT       250000                    // UDP packect timeout
#define UPDATE_MSG_TIME       10000 - 600                 // tuned to achieve 100Hz ros loop
...
#define MAX_BASE_ACCEL        0.05f
#define MAX_HOLO_ACCEL        0.15f
